...
/* Battery measurement — single 18650 cell (4.2 V full, 3.0 V empty).
 ...
 * BATT_FULL_MV / BATT_EMPTY_MV: cell voltage at 100 % / 0 % SoC. */
...
#define CONFIG_WELLD_ADS1115_DRDY_GPIO       22
